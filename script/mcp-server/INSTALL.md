...
**机器 B Token:** `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`
...
```json
{
  "mcpServers": {
    "relay-review": {
      ...
      "env": {
        "GITHUB_TOKEN": "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",
...
确保设置了正确的环境变量:
```bash
export GITHUB_TOKEN="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"
